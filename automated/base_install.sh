...
pacstrap /mnt base base-devel linux linux-firmware linux-headers util-linux mkinitcpio lvm2 vim dhcpcd networkmanager wpa_supplicant dialog git curl wget bash-completion
