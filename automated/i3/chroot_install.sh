...
read -p "Continue with GRUB and mkinitcpio.conf manual setup"

#inside /etc/default/grub add:
# ls -l /dev/disk/by-uuid
#GRUB_CMD_LINUX="cryptdevice=/dev/sdx:cryptroot"
#grub-mkconfig -o /boot/grub/grub.cfg

#inside /etc/mkinitcpio.conf add:
# HOOKS -> add encrypt after keyboard
# mkinitcpio -p linux